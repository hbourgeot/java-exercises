...
public class Calculadora extends javax.swing.JFrame {
  ...
  private void initComponents() {
    ...
    jLabel1.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 24)); // NOI18N
    jLabel1.setForeground(new java.awt.Color(0, 0, 0));
    jLabel1.setText("Calculadora");

    numero1.setText("3");

    jLabel2.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 18)); // NOI18N
    jLabel2.setForeground(new java.awt.Color(0, 0, 0));
    jLabel2.setText("Número 1");

    jLabel3.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 18)); // NOI18N
    jLabel3.setForeground(new java.awt.Color(0, 0, 0));
    jLabel3.setText("Número 2");

    numero2.setText("4");

    sumarBtn.setBackground(new java.awt.Color(0, 0, 102));
    sumarBtn.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 12)); // NOI18N
    sumarBtn.setForeground(new java.awt.Color(255, 255, 255));
    sumarBtn.setText("Sumar");
    sumarBtn.setToolTipText("");
    sumarBtn.setBorder(null);
    ...
    restarBtn.setBackground(new java.awt.Color(0, 0, 102));
    restarBtn.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 12)); // NOI18N
    restarBtn.setForeground(new java.awt.Color(255, 255, 255));
    ...
    multBtn.setBackground(new java.awt.Color(0, 0, 102));
    multBtn.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 12)); // NOI18N
    multBtn.setForeground(new java.awt.Color(255, 255, 255));
    multBtn.setText("Multiplicar");
    multBtn.setBorder(null);
    ...
    dividirBtn.setBackground(new java.awt.Color(0, 0, 102));
    dividirBtn.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 12)); // NOI18N
    dividirBtn.setForeground(new java.awt.Color(255, 255, 255));
    dividirBtn.setText("Dividir");
    dividirBtn.setBorder(null);
    ...
    cleanBtn.setBackground(new java.awt.Color(0, 51, 204));
    cleanBtn.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 12)); // NOI18N
    ...
    resultadoLabel.setFont(new java.awt.Font("CaskaydiaCove Nerd Font", 0, 24)); // NOI18N
    ...
    jPanel1Layout.setHorizontalGroup(
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        .addGap(83, 83, 83)
        .addComponent(sumarBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addComponent(restarBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addComponent(multBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        .addComponent(dividirBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
        .addGap(104, 104, 104))
      .addGroup(jPanel1Layout.createSequentialGroup()
        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
          .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    jPanel1Layout.setVerticalGroup(
      ...
      .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
          .addComponent(sumarBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        .addComponent(cleanBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
        .addGap(48, 48, 48))
    );
  ...
  private void multBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_multBtnActionPerformed
    ...
    // JOptionPane.showMessageDialog(rootPane, "El resultado es: " + res, "Resultado", JOptionPane.INFORMATION_MESSAGE);
    
    resultadoLabel.setText("El resultado es: " + res);
